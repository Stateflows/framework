...
{
    public interface IAggregateSubscriptions<TReturn>
    {
        /// <summary>
        ...
        Task<bool> TrySubscribeAsync<TNotification>(BehaviorId behaviorId);
        ...
        Task<bool> TryUnsubscribeAsync<TNotification>(BehaviorId behaviorId);
    }
}