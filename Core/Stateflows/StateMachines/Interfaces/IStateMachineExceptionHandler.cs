...
namespace Stateflows.StateMachines
{
    ...
    {
        Task OnStateMachineInitializeExceptionAsync(IStateMachineInitializationContext context, Exception exception);
        Task OnStateMachineFinalizeExceptionAsync(IStateMachineActionContext context, Exception exception);
        ...
        Task OnStateFinalizeExceptionAsync(IStateActionContext context, Exception exception);
