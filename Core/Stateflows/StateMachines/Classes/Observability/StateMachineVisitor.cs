...
namespace Stateflows.StateMachines
{
    ...
    {
        public virtual Task StateMachineAddedAsync(string stateMachineName, int stateMachineVersion, BehaviorClass? ownerClass = null, BehaviorClass? parentClass = null, bool isDefaultInstance = false)
            => Task.CompletedTask;
