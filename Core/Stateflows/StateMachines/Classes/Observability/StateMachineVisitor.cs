...
namespace Stateflows.StateMachines
{
    ...
    {
        public virtual Task StateMachineAddedAsync(string stateMachineName, int stateMachineVersion, bool isSystemRegistration = false, bool isDefaultInstance = false)
            => Task.CompletedTask;
