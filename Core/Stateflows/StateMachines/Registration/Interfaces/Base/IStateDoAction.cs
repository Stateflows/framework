...
namespace Stateflows.StateMachines.Registration.Interfaces.Base
{
    public interface IStateDoAction<out TReturn>
    {
        ...
        TReturn AddDoAction(string doActionName, EmbeddedBehaviorBuildAction buildAction = null, StateActionInitializationBuilderAsync initializationBuilder = null);
        ...
        /// <param name="initializationBuilder">Initialization builder; generates initialization event for embedded State Machine</param>
        [DebuggerHidden]
        public TReturn AddDoAction<TAction>(EmbeddedBehaviorBuildAction buildAction = null, StateActionInitializationBuilderAsync initializationBuilder = null)
