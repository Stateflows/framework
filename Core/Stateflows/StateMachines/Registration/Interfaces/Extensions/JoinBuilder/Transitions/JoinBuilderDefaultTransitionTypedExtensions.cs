...
{
    public static class JoinBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static void AddTransition<TTransition, TTargetState>(this IJoinBuilder builder, DefaultTransitionEffectBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static void AddTransition<TTransition>(this IJoinBuilder builder, string targetStateName, DefaultTransitionEffectBuildAction transitionBuildAction = null)
            where TTransition : class, IDefaultTransition
        {
        ...
        [DebuggerHidden]
        public static void AddTransition<TTargetState>(this IJoinBuilder builder, DefaultTransitionEffectBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
