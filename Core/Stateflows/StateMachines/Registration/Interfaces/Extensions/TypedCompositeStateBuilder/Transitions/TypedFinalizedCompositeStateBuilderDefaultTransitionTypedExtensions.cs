...
namespace Stateflows.StateMachines.Typed
{
    public static class TypedFinalizedCompositeStateBuilderDefaultTransitionTypedExtensions
    {
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static ITypedFinalizedCompositeStateBuilder AddDefaultTransition<TDefaultTransition, TTargetState>(this ITypedFinalizedCompositeStateBuilder builder)
        ...
        [DebuggerHidden]
        public static ITypedFinalizedCompositeStateBuilder AddDefaultTransition<TDefaultTransition>(this ITypedFinalizedCompositeStateBuilder builder, string targetStateName)
            where TDefaultTransition : class, IDefaultTransition
            => (builder as ICompositeStateBuilder).AddDefaultTransition<TDefaultTransition>(targetStateName) as ITypedFinalizedCompositeStateBuilder;
