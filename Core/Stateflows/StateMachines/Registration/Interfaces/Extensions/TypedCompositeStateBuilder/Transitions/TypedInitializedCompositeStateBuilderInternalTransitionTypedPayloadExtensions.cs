...
namespace Stateflows.StateMachines.Typed.Data
{
    ...
    {
        public static ITypedInitializedCompositeStateBuilder AddInternalTransition<TEventPayload, TTransition>(this ITypedInitializedCompositeStateBuilder builder)
