...
namespace Stateflows.StateMachines.Data
{
    public static class TypedInitializedCompositeStateBuilderPayloadExtensions
    {
        ...
        public static ITypedInitializedCompositeStateBuilder AddInternalDataTransition<TEventPayload>(this ITypedInitializedCompositeStateBuilder builder, TransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
