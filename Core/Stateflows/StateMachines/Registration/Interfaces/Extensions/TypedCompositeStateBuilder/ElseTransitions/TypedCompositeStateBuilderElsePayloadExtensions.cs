...
namespace Stateflows.StateMachines.Data
{
    public static class TypedCompositeStateBuilderElsePayloadExtensions
    {
        ...
        public static ITypedCompositeStateBuilder AddElseInternalDataTransition<TEventPayload>(this ITypedCompositeStateBuilder builder, ElseTransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
