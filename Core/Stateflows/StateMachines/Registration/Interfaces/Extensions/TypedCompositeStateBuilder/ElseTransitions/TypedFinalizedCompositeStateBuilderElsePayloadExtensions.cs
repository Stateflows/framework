...
namespace Stateflows.StateMachines.Data
{
    public static class TypedFinalizedCompositeStateBuilderElsePayloadExtensions
    {
        ...
        public static ITypedFinalizedCompositeStateBuilder AddElseInternalDataTransition<TEventPayload>(this ITypedFinalizedCompositeStateBuilder builder, ElseInternalTransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
