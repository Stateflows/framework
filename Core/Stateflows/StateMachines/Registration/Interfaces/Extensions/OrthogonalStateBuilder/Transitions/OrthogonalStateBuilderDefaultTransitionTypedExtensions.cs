...
{
    public static class OrthogonalStateBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddDefaultTransition<TDefaultTransition, TTargetState>(this IOrthogonalStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddDefaultTransition<TDefaultTransition>(this IOrthogonalStateBuilder builder, string targetStateName, DefaultTransitionBuildAction transitionBuildAction = null)
            where TDefaultTransition : class, IDefaultTransition
            => (builder as IStateBuilder).AddDefaultTransition<TDefaultTransition>(targetStateName, transitionBuildAction) as IOrthogonalStateBuilder;
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddDefaultTransition<TTargetState>(this IOrthogonalStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
