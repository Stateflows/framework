...
{
    public static class OrthogonalStateBuilderTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddTransition<TEvent, TTransition, TTargetState>(this IOrthogonalStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddTransition<TEvent, TTransition>(this IOrthogonalStateBuilder builder, string targetStateName, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTransition : class, ITransition<TEvent>
        {
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddTransition<TEvent, TTargetState>(this IOrthogonalStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
