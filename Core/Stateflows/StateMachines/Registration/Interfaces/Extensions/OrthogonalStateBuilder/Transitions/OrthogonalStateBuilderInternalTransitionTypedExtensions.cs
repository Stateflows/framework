...
{
    public static class OrthogonalStateBuilderInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddInternalTransition<TEvent, TTransition>(this IOrthogonalStateBuilder builder, InternalTransitionBuildAction<TEvent> transitionBuildAction = null)
