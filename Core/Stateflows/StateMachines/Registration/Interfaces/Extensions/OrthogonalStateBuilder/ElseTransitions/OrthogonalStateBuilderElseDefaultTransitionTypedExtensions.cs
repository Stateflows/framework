...
{
    public static class OrthogonalStateBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddElseDefaultTransition<TElseTransition, TTargetState>(this IOrthogonalStateBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddElseDefaultTransition<TElseTransition>(this IOrthogonalStateBuilder builder, string targetStateName, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TElseTransition : class, IDefaultTransitionEffect
            => (builder as IStateBuilder).AddElseDefaultTransition<TElseTransition>(targetStateName, transitionBuildAction) as IOrthogonalStateBuilder;
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddElseDefaultTransition<TTargetState>(this IOrthogonalStateBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
