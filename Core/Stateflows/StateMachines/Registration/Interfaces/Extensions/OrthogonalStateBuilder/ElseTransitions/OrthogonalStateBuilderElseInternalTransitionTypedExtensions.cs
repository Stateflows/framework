...
{
    public static class OrthogonalStateBuilderElseInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IOrthogonalStateBuilder AddElseInternalTransition<TEvent, TElseTransition>(this IOrthogonalStateBuilder builder, ElseInternalTransitionBuildAction<TEvent> transitionBuildAction = null)
