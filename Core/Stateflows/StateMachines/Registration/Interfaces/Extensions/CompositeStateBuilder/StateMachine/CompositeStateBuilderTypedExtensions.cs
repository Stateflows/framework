    ...
    public static class CompositeStateBuilderTypedExtensions
    {
            ...
            where TCompositeState : CompositeState
        {
            ...
            return builder.AddCompositeState(
                ...
                b =>
                {
                    (b as ICompositeStateBuilder).AddStateEvents<TCompositeState, ICompositeStateBuilder>(self.Vertex.Graph);
                    (b as ICompositeStateBuilder).AddCompositeStateEvents<TCompositeState, ICompositeStateBuilder>(self.Vertex.Graph);
