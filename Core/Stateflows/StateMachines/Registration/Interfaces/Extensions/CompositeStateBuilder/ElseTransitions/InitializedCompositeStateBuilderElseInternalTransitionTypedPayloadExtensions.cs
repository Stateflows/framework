...
namespace Stateflows.StateMachines.Typed.Data
{
    ...
    {
        public static IInitializedCompositeStateBuilder AddElseInternalDataTransition<TEventPayload, TElseTransition>(this IInitializedCompositeStateBuilder builder)
