...
namespace Stateflows.StateMachines.Typed
{
    public static class CompositeStateBuilderElseTransitionTypedExtensions
    {
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static ICompositeStateBuilder AddElseTransition<TEvent, TElseTransition, TTargetState>(this ICompositeStateBuilder builder, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static ICompositeStateBuilder AddElseTransition<TEvent, TElseTransition>(this ICompositeStateBuilder builder, string targetStateName, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TElseTransition : class, ITransitionEffect<TEvent>
            => (builder as IStateBuilder).AddElseTransition<TEvent, TElseTransition>(targetStateName, transitionBuildAction) as ICompositeStateBuilder;
