...
namespace Stateflows.StateMachines.Typed.Data
{
    public static class InitializedCompositeStateBuilderElseTransitionTypedPayloadExtensions
    {
        ...
        public static IInitializedCompositeStateBuilder AddElseTransition<TEventPayload, TTargetState>(this IInitializedCompositeStateBuilder builder, ElseTransitionBuilderAction<Event<TEventPayload>> transitionBuildAction = null)
            where TTargetState : State
