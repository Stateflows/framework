...
namespace Stateflows.StateMachines.Data
{
    public static class FinalizedCompositeStateBuilderElsePayloadExtensions
    {
        ...
        public static IFinalizedCompositeStateBuilder AddElseInternalDataTransition<TEventPayload>(this IFinalizedCompositeStateBuilder builder, ElseTransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
