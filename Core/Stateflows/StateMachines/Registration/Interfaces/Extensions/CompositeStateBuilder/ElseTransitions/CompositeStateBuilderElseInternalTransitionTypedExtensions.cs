...
namespace Stateflows.StateMachines.Typed
{
    public static class CompositeStateBuilderElseInternalTransitionTypedExtensions
    {
        ...
        [DebuggerHidden]
        public static ICompositeStateBuilder AddElseInternalTransition<TEvent, TElseTransition>(this ICompositeStateBuilder builder, ElseInternalTransitionBuildAction<TEvent> transitionBuildAction = null)
