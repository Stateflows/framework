...
namespace Stateflows.StateMachines.Data
{
    public static class CompositeStateBuilderPayloadExtensions
    {
        ...
        public static ICompositeStateBuilder AddInternalDataTransition<TEventPayload>(this ICompositeStateBuilder builder, TransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
