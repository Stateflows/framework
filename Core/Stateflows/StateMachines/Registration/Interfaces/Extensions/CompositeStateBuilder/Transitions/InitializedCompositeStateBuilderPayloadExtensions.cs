...
namespace Stateflows.StateMachines.Data
{
    public static class InitializedCompositeStateBuilderPayloadExtensions
    {
        ...
        public static IInitializedCompositeStateBuilder AddInternalDataTransition<TEventPayload>(this IInitializedCompositeStateBuilder builder, TransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
