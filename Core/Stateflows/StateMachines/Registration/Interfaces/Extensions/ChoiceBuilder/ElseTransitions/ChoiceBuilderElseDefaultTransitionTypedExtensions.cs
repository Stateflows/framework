...
namespace Stateflows.StateMachines.Typed
{
    public static class ChoiceBuilderElseDefaultTransitionTypedExtensions
    {
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition, TTargetState>(this IChoiceBuilder builder)
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition>(this IChoiceBuilder builder, string targetStateName)
            where TElseTransition : class, IDefaultTransitionEffect
        {
