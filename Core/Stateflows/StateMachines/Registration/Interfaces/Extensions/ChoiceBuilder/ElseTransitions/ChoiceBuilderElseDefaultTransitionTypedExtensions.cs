...
{
    public static class ChoiceBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition, TTargetState>(this IChoiceBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition>(this IChoiceBuilder builder, string targetStateName, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TElseTransition : class, IDefaultTransitionEffect
        {
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TTargetState>(this IChoiceBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
