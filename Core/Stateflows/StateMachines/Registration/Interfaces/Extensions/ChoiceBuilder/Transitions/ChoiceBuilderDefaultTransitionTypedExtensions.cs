...
{
    public static class ChoiceBuilderDefaultTransitionTypedExtensions
    {
        ///// <summary>
        ...
        [DebuggerHidden]
        public static IChoiceBuilder AddTransition<TTargetState>(this IChoiceBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
