...
{
    public static class InitializedRegionBuilderTypedExtensions
    {
        ...
        [DebuggerHidden]
        public static IFinalizedRegionBuilder AddState<TFinalState>(this IInitializedRegionBuilder builder, string finalStateName = FinalState.Name)
        ...
        [DebuggerHidden]
        public static IInitializedRegionBuilder AddState<TState>(this IInitializedRegionBuilder builder, StateBuildAction stateBuildAction = null)
        ...
        /// <returns></returns>
        [DebuggerHidden]
        public static IInitializedRegionBuilder AddState<TState>(this IInitializedRegionBuilder builder, string stateName, StateBuildAction stateBuildAction = null)
            where TState : class, IState
        {
        ...
        [DebuggerHidden]
        public static IInitializedRegionBuilder AddCompositeState<TCompositeState>(this IInitializedRegionBuilder builder, CompositeStateBuildAction compositeStateBuildAction)
        ...
        /// <param name="compositeStateBuildAction">Composite state build action</param>
        [DebuggerHidden]
        public static IInitializedRegionBuilder AddCompositeState<TCompositeState>(this IInitializedRegionBuilder builder, string compositeStateName, CompositeStateBuildAction compositeStateBuildAction)
            where TCompositeState : class, ICompositeState
        {
        ...
        [DebuggerHidden]
        public static IInitializedRegionBuilder AddOrthogonalState<TOrthogonalState>(this IInitializedRegionBuilder builder, OrthogonalStateBuildAction orthogonalStateBuildAction)
        ...
        /// <param name="orthogonalStateBuildAction">Orthogonal state build action</param>
        [DebuggerHidden]
        public static IInitializedRegionBuilder AddOrthogonalState<TOrthogonalState>(this IInitializedRegionBuilder builder, string orthogonalStateName, OrthogonalStateBuildAction orthogonalStateBuildAction)
            where TOrthogonalState : class, IOrthogonalState
        {
