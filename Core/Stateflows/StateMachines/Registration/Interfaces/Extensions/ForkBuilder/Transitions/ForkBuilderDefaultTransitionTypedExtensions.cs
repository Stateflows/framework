...
{
    public static class ForkBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IForkBuilder AddTransition<TTransition, TTargetState>(this IForkBuilder builder, DefaultTransitionEffectBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IForkBuilder AddTransition<TTransition>(this IForkBuilder builder, string targetStateName, DefaultTransitionEffectBuildAction transitionBuildAction = null)
            where TTransition : class, IDefaultTransition
        {
        ...
        [DebuggerHidden]
        public static IForkBuilder AddTransition<TTargetState>(this IForkBuilder builder, DefaultTransitionEffectBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
