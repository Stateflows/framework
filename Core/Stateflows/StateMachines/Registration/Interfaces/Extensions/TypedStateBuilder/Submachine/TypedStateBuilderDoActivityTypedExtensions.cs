...
{
    public static class TypedStateBuilderDoActivityTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IBehaviorTypedStateBuilder AddDoActivity<TActivity>(this ITypedStateBuilder builder, EmbeddedBehaviorBuildAction buildAction = null, StateActionInitializationBuilderAsync initializationBuilder = null)
