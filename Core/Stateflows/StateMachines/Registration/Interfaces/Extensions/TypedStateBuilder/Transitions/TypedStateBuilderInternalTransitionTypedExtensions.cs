...
namespace Stateflows.StateMachines.Typed
{
    public static class TypedStateBuilderInternalTransitionTypedExtensions
    {
        ...
        [DebuggerHidden]
        public static ITypedStateBuilder AddInternalTransition<TEvent, TTransition>(this ITypedStateBuilder builder, InternalTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTransition : class, ITransition<TEvent>
            => builder.AddTransition<TEvent, TTransition>(Constants.DefaultTransitionTarget, transitionBuildAction);
    }
}
