...
namespace Stateflows.StateMachines.Data
{
    public static class TypedStateBuilderElsePayloadExtensions
    {
        ...
        public static ITypedStateBuilder AddElseInternalDataTransition<TEventPayload>(this ITypedStateBuilder builder, ElseTransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
