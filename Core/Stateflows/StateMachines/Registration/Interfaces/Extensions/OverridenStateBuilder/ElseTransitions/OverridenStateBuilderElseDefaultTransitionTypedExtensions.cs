...
{
    public static class OverridenStateBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IOverridenStateBuilder AddElseDefaultTransition<TElseTransition, TTargetState>(this IOverridenStateBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
        ...
        /// <param name="transitionBuildAction">Transition build action</param>
        [DebuggerHidden]
        public static IOverridenStateBuilder AddElseDefaultTransition<TElseTransition>(this IOverridenStateBuilder builder, string targetStateName, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TElseTransition : class, IDefaultTransitionEffect
        {
        ...
        /// <param name="transitionBuildAction">Transition build action</param>
        [DebuggerHidden]
        public static IOverridenStateBuilder AddElseDefaultTransition<TTargetState>(this IOverridenStateBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
