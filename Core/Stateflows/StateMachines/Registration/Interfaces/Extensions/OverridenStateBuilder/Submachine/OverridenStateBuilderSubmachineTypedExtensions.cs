...
{
    public static class OverridenStateBuilderSubmachineTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddSubmachine<TStateMachine>(this IOverridenStateBuilder builder, EmbeddedBehaviorBuildAction buildAction = null, StateActionInitializationBuilderAsync initializationBuilder = null)
