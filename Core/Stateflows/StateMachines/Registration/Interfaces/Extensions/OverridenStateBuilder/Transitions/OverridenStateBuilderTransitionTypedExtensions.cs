...
{
    public static class OverridenStateBuilderTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IOverridenStateBuilder AddTransition<TEvent, TTransition, TTargetState>(this IOverridenStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        /// <param name="transitionBuildAction">Transition build action</param>
        [DebuggerHidden]
        public static IOverridenStateBuilder AddTransition<TEvent, TTransition>(this IOverridenStateBuilder builder, string targetStateName, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTransition : class, ITransition<TEvent>
        {
        ...
        /// <param name="transitionBuildAction">Transition build action</param>
        [DebuggerHidden]
        public static IOverridenStateBuilder AddTransition<TEvent, TTargetState>(this IOverridenStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
