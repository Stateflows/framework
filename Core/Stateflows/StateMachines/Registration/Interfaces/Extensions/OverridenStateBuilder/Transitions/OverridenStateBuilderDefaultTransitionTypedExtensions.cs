...
{
    public static class OverridenStateBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IOverridenStateBuilder AddDefaultTransition<TTransition, TTargetState>(this IOverridenStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
        ...
        /// <param name="transitionBuildAction">Transition build action</param>
        [DebuggerHidden]
        public static IOverridenStateBuilder AddDefaultTransition<TTransition>(this IOverridenStateBuilder builder, string targetStateName, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTransition : class, IDefaultTransition
        {
        ...
        /// <param name="transitionBuildAction">Transition build action</param>
        [DebuggerHidden]
        public static IOverridenStateBuilder AddDefaultTransition<TTargetState>(this IOverridenStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
