...
{
    public static class OverridenStateBuilderInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IOverridenStateBuilder AddInternalTransition<TEvent, TTransition>(this IOverridenStateBuilder builder, InternalTransitionBuildAction<TEvent> transitionBuildAction = null)
