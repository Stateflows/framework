...
{
    public static class OverridenStateMachineBuilderEventsTypedExtensions
    {
        [DebuggerHidden]
        public static IOverridenStateMachineBuilder AddDefaultInitializer<TInitializer>(this IOverridenStateMachineBuilder builder)
        ...
        [DebuggerHidden]
        public static IOverridenStateMachineBuilder AddInitializer<TInitializationEvent, TInitializer>(this IOverridenStateMachineBuilder builder)
        ...
        [DebuggerHidden]
        public static IOverridenStateMachineBuilder AddFinalizer<TFinalizer>(this IOverridenStateMachineBuilder builder)
