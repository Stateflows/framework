...
namespace Stateflows.StateMachines.Typed.Data
{
    ...
    {
        public static IStateBuilder AddDataTransition<TEventPayload, TTransition, TTargetState>(this IStateBuilder builder)
        ...
        public static IStateBuilder AddDataTransition<TEventPayload, TTransition>(this IStateBuilder builder, string targetVertexName)
            where TTransition : Transition<Event<TEventPayload>>
        {
        ...
        public static IStateBuilder AddDataTransition<TEventPayload, TTargetState>(this IStateBuilder builder, TransitionBuildAction<Event<TEventPayload>> transitionBuildAction = null)
            where TTargetState : BaseState
