...
namespace Stateflows.StateMachines.Typed
{
    public static class StateBuilderDoActivityTypedExtensions
    {
        ...
        [DebuggerHidden]
        public static IBehaviorStateBuilder AddDoActivity<TActivity>(this IStateBuilder builder, EmbeddedBehaviorBuildAction buildAction = null, StateActionInitializationBuilderAsync initializationBuilder = null)
