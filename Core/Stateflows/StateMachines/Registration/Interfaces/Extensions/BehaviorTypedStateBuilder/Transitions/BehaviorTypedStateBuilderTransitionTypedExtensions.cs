...
{
    public static class BehaviorTypedStateBuilderTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IBehaviorTypedStateBuilder AddTransition<TEvent, TTransition, TTargetState>(this IBehaviorTypedStateBuilder builder)
        ...
        [DebuggerHidden]
        public static IBehaviorTypedStateBuilder AddTransition<TEvent, TTransition>(this IBehaviorTypedStateBuilder builder, string targetStateName)
            where TTransition : class, ITransition<TEvent>
        {
        ...
        [DebuggerHidden]
        public static IBehaviorTypedStateBuilder AddTransition<TEvent, TTargetState>(this IBehaviorTypedStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
