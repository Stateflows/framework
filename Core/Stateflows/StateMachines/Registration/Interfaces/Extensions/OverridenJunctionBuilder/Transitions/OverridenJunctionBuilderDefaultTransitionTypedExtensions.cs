...
{
    public static class OverridenJunctionBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOverridenJunctionBuilder AddTransition<TTransition, TTargetState>(this IOverridenJunctionBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOverridenJunctionBuilder AddTransition<TTransition>(this IOverridenJunctionBuilder builder, string targetStateName, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTransition : class, IDefaultTransition
        {
        ...
        [DebuggerHidden]
        public static IOverridenJunctionBuilder AddTransition<TTargetState>(this IOverridenJunctionBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
