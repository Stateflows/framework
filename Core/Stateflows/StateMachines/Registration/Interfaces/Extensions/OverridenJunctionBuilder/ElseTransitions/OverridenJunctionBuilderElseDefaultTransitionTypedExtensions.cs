...
{
    public static class OverridenJunctionBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition, TTargetState>(this IOverridenJunctionBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition>(this IOverridenJunctionBuilder builder, string targetStateName, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TElseTransition : class, IDefaultTransitionEffect
        {
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TTargetState>(this IOverridenJunctionBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
