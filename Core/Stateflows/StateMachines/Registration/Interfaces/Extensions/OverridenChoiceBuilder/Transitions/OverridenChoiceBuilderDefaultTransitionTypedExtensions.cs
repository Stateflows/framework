...
{
    public static class OverridenChoiceBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOverridenChoiceBuilder AddTransition<TTransition, TTargetState>(this IOverridenChoiceBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOverridenChoiceBuilder AddTransition<TTransition>(this IOverridenChoiceBuilder builder, string targetStateName, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTransition : class, IDefaultTransition
        {
        ...
        [DebuggerHidden]
        public static IOverridenChoiceBuilder AddTransition<TTargetState>(this IOverridenChoiceBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
