...
{
    public static class OverridenChoiceBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition, TTargetState>(this IOverridenChoiceBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TElseTransition>(this IOverridenChoiceBuilder builder, string targetStateName, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TElseTransition : class, IDefaultTransitionEffect
        {
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TTargetState>(this IOverridenChoiceBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
