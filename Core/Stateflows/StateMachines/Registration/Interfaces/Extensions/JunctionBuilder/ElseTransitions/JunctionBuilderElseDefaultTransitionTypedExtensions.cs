...
{
    public static class JunctionBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static void AddElseTransition<TTargetState>(this IJunctionBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
