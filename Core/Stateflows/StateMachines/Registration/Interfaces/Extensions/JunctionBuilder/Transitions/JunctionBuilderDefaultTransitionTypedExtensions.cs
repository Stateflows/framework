...
{
    public static class JunctionBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IJunctionBuilder AddTransition<TTransition, TTargetState>(this IJunctionBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IJunctionBuilder AddTransition<TTransition>(this IJunctionBuilder builder, string targetStateName, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTransition : class, IDefaultTransition
        {
        ...
        [DebuggerHidden]
        public static IJunctionBuilder AddTransition<TTargetState>(this IJunctionBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
