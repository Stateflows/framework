...
{
    public static class OverridenBehaviorStateBuilderElseInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddElseInternalTransition<TEvent, TElseTransition>(this IBehaviorOverridenStateBuilder builder)
