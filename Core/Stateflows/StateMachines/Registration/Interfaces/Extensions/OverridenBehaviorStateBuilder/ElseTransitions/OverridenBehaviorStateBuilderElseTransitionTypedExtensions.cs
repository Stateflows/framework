...
{
    public static class OverridenBehaviorStateBuilderElseTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddElseTransition<TEvent, TElseTransition, TTargetState>(this IBehaviorOverridenStateBuilder builder)
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddElseTransition<TEvent, TElseTransition>(this IBehaviorOverridenStateBuilder builder, string targetStateName)
            where TElseTransition : class, ITransitionEffect<TEvent>
        {
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddElseTransition<TEvent, TTargetState>(this IBehaviorOverridenStateBuilder builder, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
