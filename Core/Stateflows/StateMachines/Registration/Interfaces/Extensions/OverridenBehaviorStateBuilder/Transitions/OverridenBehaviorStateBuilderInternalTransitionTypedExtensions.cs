...
{
    public static class OverridenBehaviorStateBuilderInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddInternalTransition<TEvent, TTransition>(this IBehaviorOverridenStateBuilder builder)
