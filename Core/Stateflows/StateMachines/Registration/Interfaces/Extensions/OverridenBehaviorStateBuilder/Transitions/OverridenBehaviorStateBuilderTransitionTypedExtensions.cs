...
{
    public static class OverridenBehaviorStateBuilderTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddTransition<TEvent, TTransition, TTargetState>(this IBehaviorOverridenStateBuilder builder)
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddTransition<TEvent, TTransition>(this IBehaviorOverridenStateBuilder builder, string targetStateName)
            where TTransition : class, ITransition<TEvent>
        {
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddTransition<TEvent, TTargetState>(this IBehaviorOverridenStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
