...
{
    public static class OverridenBehaviorStateBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddDefaultTransition<TTransition, TTargetState>(this IBehaviorOverridenStateBuilder builder)
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddDefaultTransition<TTransition>(this IBehaviorOverridenStateBuilder builder, string targetStateName)
            where TTransition : class, IDefaultTransition
        {
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddDefaultTransition<TTargetState>(this IBehaviorOverridenStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
