...
{
    public static class OverridenBehaviorStateBuilderEventsSyncExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddOnEntry(this IBehaviorOverridenStateBuilder builder, Action<IStateActionContext> action)
        ...
        /// <param name="action">Synchronous action handler</param>
        [DebuggerHidden]
        public static IBehaviorOverridenStateBuilder AddOnExit(this IBehaviorOverridenStateBuilder builder, Action<IStateActionContext> action)
