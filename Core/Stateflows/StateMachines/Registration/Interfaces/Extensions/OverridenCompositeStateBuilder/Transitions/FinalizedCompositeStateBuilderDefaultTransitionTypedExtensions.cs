...
{
    public static class OverridenFinalizedCompositeStateBuilderDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddDefaultTransition<TDefaultTransition, TTargetState>(this IFinalizedOverridenCompositeStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddDefaultTransition<TDefaultTransition>(this IFinalizedOverridenCompositeStateBuilder builder, string targetStateName, DefaultTransitionBuildAction transitionBuildAction = null)
            where TDefaultTransition : class, IDefaultTransition
            => (builder as IStateBuilder).AddDefaultTransition<TDefaultTransition>(targetStateName, transitionBuildAction) as IFinalizedOverridenCompositeStateBuilder;
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddDefaultTransition<TTargetState>(this IFinalizedOverridenCompositeStateBuilder builder, DefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
