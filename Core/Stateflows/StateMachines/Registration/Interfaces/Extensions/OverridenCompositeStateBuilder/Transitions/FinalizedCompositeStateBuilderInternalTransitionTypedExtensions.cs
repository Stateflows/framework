...
{
    public static class OverridenFinalizedCompositeStateBuilderInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddInternalTransition<TEvent, TTransition>(this IFinalizedOverridenCompositeStateBuilder builder, InternalTransitionBuildAction<TEvent> transitionBuildAction = null)
