...
{
    public static class OverridenFinalizedCompositeStateBuilderTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddTransition<TEvent, TTransition, TTargetState>(this IFinalizedOverridenCompositeStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddTransition<TEvent, TTransition>(this IFinalizedOverridenCompositeStateBuilder builder, string targetStateName, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTransition : class, ITransition<TEvent>
            => (builder as ICompositeStateBuilder).AddTransition<TEvent, TTransition>(targetStateName, transitionBuildAction) as IFinalizedOverridenCompositeStateBuilder;
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddTransition<TEvent, TTargetState>(this IFinalizedOverridenCompositeStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
