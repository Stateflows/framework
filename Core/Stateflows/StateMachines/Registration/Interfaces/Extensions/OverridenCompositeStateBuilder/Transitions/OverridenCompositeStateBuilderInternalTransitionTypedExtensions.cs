...
{
    public static class OverridenCompositeStateBuilderInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddInternalTransition<TEvent, TTransition>(this IOverridenCompositeStateBuilder builder, InternalTransitionBuildAction<TEvent> transitionBuildAction = null)
