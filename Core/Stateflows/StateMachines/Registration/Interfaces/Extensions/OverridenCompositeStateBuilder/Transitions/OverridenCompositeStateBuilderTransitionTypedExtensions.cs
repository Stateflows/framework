...
{
    public static class OverridenCompositeStateBuilderTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddTransition<TEvent, TTransition, TTargetState>(this IOverridenCompositeStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddTransition<TEvent, TTransition>(this IOverridenCompositeStateBuilder builder, string targetStateName, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTransition : class, ITransition<TEvent>
        {
        ...
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddTransition<TEvent, TTargetState>(this IOverridenCompositeStateBuilder builder, TransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
