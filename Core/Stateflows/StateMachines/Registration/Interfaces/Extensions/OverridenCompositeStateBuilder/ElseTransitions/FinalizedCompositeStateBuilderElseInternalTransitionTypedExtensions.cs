...
{
    public static class OverridenFinalizedCompositeStateBuilderElseInternalTransitionTypedExtensions
    {
        /// <summary>
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddElseInternalTransition<TEvent, TElseTransition>(this IFinalizedOverridenCompositeStateBuilder builder, ElseInternalTransitionBuildAction<TEvent> transitionBuildAction = null)
