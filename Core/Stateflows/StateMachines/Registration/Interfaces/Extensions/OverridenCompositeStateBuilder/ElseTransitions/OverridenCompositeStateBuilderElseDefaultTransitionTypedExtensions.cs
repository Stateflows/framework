...
{
    public static class OverridenCompositeStateBuilderElseDefaultTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddElseDefaultTransition<TElseTransition, TTargetState>(this IOverridenCompositeStateBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddElseDefaultTransition<TElseTransition>(this IOverridenCompositeStateBuilder builder, string targetStateName, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TElseTransition : class, IDefaultTransitionEffect
            => (builder as IStateBuilder).AddElseDefaultTransition<TElseTransition>(targetStateName, transitionBuildAction) as IOverridenCompositeStateBuilder;
        ...
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddElseDefaultTransition<TTargetState>(this IOverridenCompositeStateBuilder builder, ElseDefaultTransitionBuildAction transitionBuildAction = null)
            where TTargetState : class, IVertex
