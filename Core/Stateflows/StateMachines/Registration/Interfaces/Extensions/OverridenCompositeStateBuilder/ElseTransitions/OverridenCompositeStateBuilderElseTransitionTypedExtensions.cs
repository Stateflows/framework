...
{
    public static class OverridenCompositeStateBuilderElseTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddElseTransition<TEvent, TElseTransition, TTargetState>(this IOverridenCompositeStateBuilder builder, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddElseTransition<TEvent, TElseTransition>(this IOverridenCompositeStateBuilder builder, string targetStateName, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TElseTransition : class, ITransitionEffect<TEvent>
            => (builder as IStateBuilder).AddElseTransition<TEvent, TElseTransition>(targetStateName, transitionBuildAction) as IOverridenCompositeStateBuilder;
        ...
        [DebuggerHidden]
        public static IOverridenCompositeStateBuilder AddElseTransition<TEvent, TTargetState>(this IOverridenCompositeStateBuilder builder, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
