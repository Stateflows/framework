...
{
    public static class OverridenFinalizedCompositeStateBuilderElseTransitionTypedExtensions
    {
        /// <summary>
        ...
        /// </typeparam>
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddElseTransition<TEvent, TElseTransition, TTargetState>(this IFinalizedOverridenCompositeStateBuilder builder, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddElseTransition<TEvent, TElseTransition>(this IFinalizedOverridenCompositeStateBuilder builder, string targetStateName, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TElseTransition : class, ITransitionEffect<TEvent>
            => (builder as IStateBuilder).AddElseTransition<TEvent, TElseTransition>(targetStateName, transitionBuildAction) as IFinalizedOverridenCompositeStateBuilder;
        ...
        [DebuggerHidden]
        public static IFinalizedOverridenCompositeStateBuilder AddElseTransition<TEvent, TTargetState>(this IFinalizedOverridenCompositeStateBuilder builder, ElseTransitionBuildAction<TEvent> transitionBuildAction = null)
            where TTargetState : class, IVertex
