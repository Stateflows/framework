    ...
    public static class StateMachineBuilderTypedExtensions
    {
            ...
            where TState : State
        {
            ...
            return builder.AddState(
                ...
                b =>
                {
                    b.AddStateEvents<TState, IStateBuilder>(self.Result);
            ...
            where TCompositeState : CompositeState
        {
            ...
            return builder.AddCompositeState(
                ...
                b =>
                {
                    (b as ICompositeStateBuilder).AddStateEvents<TCompositeState, ICompositeStateBuilder>(self.Result);
                    (b as ICompositeStateBuilder).AddCompositeStateEvents<TCompositeState, ICompositeStateBuilder>(self.Result);
