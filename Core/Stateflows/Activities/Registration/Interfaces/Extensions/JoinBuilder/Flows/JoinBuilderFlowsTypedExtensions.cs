...
namespace Stateflows.Activities.Typed
{
    public static class JoinBuilderFlowsTypedExtensions
    {
        ...
        public static void AddFlow<TToken, TObjectFlow>(this IJoinBuilder builder, string targetNodeName)
            where TToken : Token, new()
        ...
        public static void AddFlow<TToken, TObjectFlow, TTargetNode>(this IJoinBuilder builder)
            where TToken : Token, new()
            where TObjectFlow : Flow<TToken>
            where TTargetNode : ActivityNode
