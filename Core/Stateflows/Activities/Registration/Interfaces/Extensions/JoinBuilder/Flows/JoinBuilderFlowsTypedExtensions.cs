...
namespace Stateflows.Activities
{
    public static class JoinBuilderFlowsTypedExtensions
    {
        ...
        [DebuggerHidden]
        public static void AddFlow<TToken, TFlow>(this IJoinBuilder builder, string targetNodeName, ObjectFlowBuildAction<TToken> buildAction = null)
        ...
        [DebuggerHidden]
        public static void AddFlow<TToken, TFlow, TTargetNode>(this IJoinBuilder builder, ObjectFlowBuildAction<TToken> buildAction = null)
            where TFlow : class, IFlow<TToken>
            where TTargetNode : class, IActivityNode
            => builder.AddFlow<TToken, TFlow>(ActivityNode<TTargetNode>.Name, buildAction);

        [DebuggerHidden]
        public static void AddFlow<TToken, TTransformedToken, TTransformationFlow>(this IJoinBuilder builder, string targetNodeName, ObjectFlowBuildAction<TTransformedToken> buildAction = null)
        ...
        [DebuggerHidden]
        public static void AddFlow<TToken, TTransformedToken, TTransformationFlow, TTargetNode>(this IJoinBuilder builder, ObjectFlowBuildAction<TTransformedToken> buildAction = null)
            where TTransformationFlow : class, IFlowTransformation<TToken, TTransformedToken>
            where TTargetNode : class, IActivityNode
