...
namespace Stateflows.Activities.Typed.Data
{
    ...
    {
        public static IInputBuilder AddDataFlow<TTokenPayload, TTargetNode>(this IInputBuilder builder, ObjectFlowBuilderAction<Token<TTokenPayload>> buildAction = null)
