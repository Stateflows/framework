...
namespace Stateflows.Activities.Data
{
    ...
    {
        public static void AddDataFlow<TTokenPayload>(this IMergeBuilder builder, string targetNodeName, ObjectFlowBuilderAction<Token<TTokenPayload>> buildAction = null)
