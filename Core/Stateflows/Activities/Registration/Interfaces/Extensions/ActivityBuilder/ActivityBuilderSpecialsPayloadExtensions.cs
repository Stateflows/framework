...
namespace Stateflows.Activities.Data
{
    ...
    {
        public static IActivityBuilder AddDataDecision<TTokenPayload>(this IActivityBuilder builder, string decisionNodeName, DecisionBuilderAction<Token<TTokenPayload>> decisionBuildAction)
