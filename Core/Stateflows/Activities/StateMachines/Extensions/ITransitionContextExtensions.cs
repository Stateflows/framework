...
namespace Stateflows.Activities
{
    internal static class ITransitionContextExtensions
    {
        ...
        internal static bool TryLocateAction<TEvent>(this ITransitionContext<TEvent> context, string actionName, string instance, out IActionBehavior iaiAgent)
            => context.TryLocateAction(new ActionId(actionName, instance), out iaiAgent);
        ...
        internal static bool TryLocateAction<TEvent>(this IDeferralContext<TEvent> context, string actionName, string instance, out IActionBehavior iaiAgent)
            => context.TryLocateAction(new ActionId(actionName, instance), out iaiAgent);
    }
}
