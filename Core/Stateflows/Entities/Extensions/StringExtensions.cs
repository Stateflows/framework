...
internal static class StringExtensions
{
    ...
    internal static string GetFieldDependenciesKey(this string fieldName) => $"$dependencies:field:{fieldName}";
    ...
    internal static string GetProjectionDependenciesKey(this string projectionName) => $"$dependencies:projection:{projectionName}";
