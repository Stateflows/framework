    ...
    public class ExternalTransitions : StateflowsTestClass
    {
        ...
        public async Task NestedToRootTransition()
        {
            ...
            ExecutionSequence.Verify(b => b
                ...
                .StateEntry("state1.1")
                .TransitionGuard(Event<CompletionEvent>.Name, "state1.1", "state1.2")
                .StateExit("state1.1")
                .TransitionEffect(Event<CompletionEvent>.Name, "state1.1", "state1.2")
                .StateEntry("state1.2")
                .TransitionGuard(Event<CompletionEvent>.Name, "state1.2", "state2")
                .StateExit("state1.2")
                .StateExit("state1")
                .TransitionEffect(Event<CompletionEvent>.Name, "state1.2", "state2")
                .StateEntry("state2")
            );
        ...
        public async Task RootToNestedTransition()
        {
            ...
            ExecutionSequence.Verify(b => b
                .StateMachineInitialize()
                .StateEntry("state1")
                .TransitionGuard(Event<CompletionEvent>.Name, "state1", "state2.1.2")
                .StateExit("state1")
                .TransitionEffect(Event<CompletionEvent>.Name, "state1", "state2.1.2")
                .StateEntry("state2")
                .StateEntry("state2.1")
        ...
        public async Task NestedToNestedTransition()
        {
            ...
            ExecutionSequence.Verify(b => b
                ...
                .TransitionEffect(Event<CompletionEvent>.Name, "state1.1", "state1.2")
                .StateEntry("state1.2")
                .TransitionGuard(Event<CompletionEvent>.Name, "state1.2", "state2.1")
                .StateExit("state1.2")
                .StateExit("state1")
                .TransitionEffect(Event<CompletionEvent>.Name, "state1.2", "state2.1")
                .StateEntry("state2")
                .StateEntry("state2.1")
                .StateEntry("state2.1.2")
            );
        ...
        public async Task NestedToParentTransition()
        {
            ...
            ExecutionSequence.Verify(b => b
                ...
                .TransitionGuard(Event<CompletionEvent>.Name, "state1.1.2", "state1.1")
                .StateExit("state1.1.2")
                .StateExit("state1.1")
                .TransitionEffect(Event<CompletionEvent>.Name, "state1.1.2", "state1.1")
                .StateEntry("state1.1")
                .StateInitialize("state1.1")
                .StateEntry("state1.1.1")
            );
