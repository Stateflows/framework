...
declare class Response extends Event$1 {
}
...
declare class Request<TResponse extends Response> extends Event$1 {
}
...
interface IBehavior {
    send(event: Event$1): Promise<SendResult>;
...
interface IStateflowsClientTransport {
    ...
    send(behaviorId: BehaviorId, event: Event$1): Promise<SendResult>;
}
