    ...
    <div class="page">
      ...
      <ng-container *ngIf="!loading(); else loadingTpl">
        <section class="section">
          ...
          <div *ngIf="classes().length === 0" class="empty">No activity classes registered.</div>
...
export class ActivitiesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    forkJoin({
      classes: this.api.getActivityClasses(),
      instances: this.api.getActivityInstances(),
    })
